        ...
        <div className="container mx-auto max-w-[1400px] px-6 lg:px-12">
          ...
          <div className="mb-16 text-center">
            <h1 className="mt-19 text-5xl font-semibold tracking-tight text-gray-900 sm:text-6xl dark:text-white">
              Hire Expert IT Talent — Without Recruitment Hassles or Overhead
              Costs
            </h1>

            <p className="font-body mx-auto mt-6 max-w-3xl text-xl leading-relaxed text-gray-600 dark:text-gray-300">
              We provide skilled IT professionals who can join your team
              instantly — giving you the flexibility to scale your workforce
              without the complexity of hiring, training, or long-term
              commitments.
            </p>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              {
                title: "Developers",
                desc: "Frontend, backend, full-stack, mobile, and cloud engineers.",
                img: "/images/features/enterprise.jpg",
              },
              {
                title: "Designers",
                desc: "UI/UX designers who craft user-friendly interfaces & experiences.",
                img: "/images/features/enterprise.jpg",
              },
              {
                title: "QA / Testers",
                desc: "Manual and automated testers ensuring product quality and reliability.",
                img: "/images/features/enterprise.jpg",
              },
              {
                title: "Project Coordinators",
                desc: "Professionals who manage timelines, communication, and delivery.",
                img: "/images/features/enterprise.jpg",
              },
              {
                title: "Technical Support Teams",
                desc: "Dedicated support teams for troubleshooting, maintenance, and customer care.",
                img: "/images/features/enterprise.jpg",
              },
            ].map((item, i) => (
              <div
